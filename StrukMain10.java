...
public class StrukMain10 {
    Scanner sc = new Scanner(System.in);
    
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        Struk10 stk = new Struk10(20);
        StrukMain10 main = new StrukMain10();
    ...
    public void pushPakaian(Struk10 stk) {
        char pilih;
        do {
            ...
            Struk10 d = new Struk10(noTra, tanggal, jumlah, total);
